...
public class DlgDltSort extends JDialog {
	...
	public DlgDltSort() {
		...
		}
		{
			...
			try {
				textFieldUpperLeftX.setText(SortFrame.getTextFieldX().getText());
			}
		...
		}
		{
			...
			try {
				textFieldUpperLeftY.setText(SortFrame.getTextFieldY().getText());
			}
		...
		
		{
			...
			
			{
				...
				try {
					textFieldWidth.setText(SortFrame.getTextFieldWidth().getText());
				}
			...
			
			{
				...
				try {
					textFieldHeight.setText(SortFrame.getTextFieldHeight().getText());
				}
